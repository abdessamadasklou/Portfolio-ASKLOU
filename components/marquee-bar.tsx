...
export function MarqueeBar() {
  ...
  const services = {
    en: ["IoT Systems", "Embedded Software", "Circuit Design", "Automation", "PCB Layout", "Smart Solutions"],
    fr: ["Systèmes IoT", "Logiciel Embarqué", "Conception de Circuits", "Automatisation", "Routage PCB", "Solutions Intelligentes"]
  }
